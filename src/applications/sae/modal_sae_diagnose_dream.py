...
app = modal.App("sae-diagnose-dream")
...
SAE_LAYER = 23  # Dream SAE coverage: {1, 5, 10, 14, 23, 27}; L23 matches best layer range
...
def main(
    ...
    print(
        f"SAE diagnose Stage 2 (Dream): dataset={dataset}, model={model}, "
