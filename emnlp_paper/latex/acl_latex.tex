...
The within-plateau steering null reported in the main text is therefore not the easiest single-layer test to fail; it is the test most likely to succeed if any layer could be controlled linearly, yet still produces $0/202$.
