...
Of $12$ cells, only LLaDA-MBPP and Qwen-JSON reach raw $p<0.05$ at step 64; no cell survives Holm-Bonferroni at $\alpha\!=\!0.05$ across $40$ sparse-grid tests. Aggregating the $14$ dense LLaDA-MBPP plateau sub-steps via Fisher's combined probability still gives $p\!<\!10^{-7}$ on every seed (Appendix~\ref{sec:appendix_dense}), so the LLaDA-MBPP plateau anchors the cross-DLM agreement claim while other cells remain descriptive.
