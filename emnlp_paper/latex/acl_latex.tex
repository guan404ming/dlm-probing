...
Code and structural tasks form a mid-denoising plateau, whereas reasoning tasks peak at the final state. This peak-phase pattern agrees across LLaDA-8B and Dream-7B on three of four tasks; no individual cell on the sparse $40$-test grid survives Holm-Bonferroni, but the LLaDA-MBPP plateau itself aggregates to Fisher's combined $p\!<\!10^{-7}$ on every seed, anchoring the trajectory claim on one fully significant cell.
